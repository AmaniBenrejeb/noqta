...
class HiChoices extends StatefulWidget {
  final String questionId;
  final Key? key;

  const HiChoices({required this.questionId, this.key}) : super(key: key);

  @override
  _HiChoicesState createState() => _HiChoicesState();
}

class _HiChoicesState extends State<HiChoices> {
  ...
  Future<void> _initializeData() async {
    ...
    // Vérifier l'existence de la question dans la collection 'History'
    final historySnapshot = await FirebaseFirestore.instance
        .collection('History')
        .doc(widget.questionId)
        .get();
    if (historySnapshot.exists) {
      // Si la question existe dans la collection 'History'
      ...
      // Si la question n'existe pas dans la collection 'History', la chercher dans la collection 'Users'
      _questionStream = FirebaseFirestore.instance
          .collection('Users')
          .doc(userId)
            ...
            return Center(
              child: Container(
                ...
                decoration: BoxDecoration(
                  ...
                  border: Border.all(color: const Color(0xFFFED159)),
                ),
                child: Column(
