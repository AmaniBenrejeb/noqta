...
class GeoQu extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        automaticallyImplyLeading: false, // This will hide the default back arrow
        title: Row(
      ...
      body: Column(
        children: [
          Expanded(
            child: Container(
              decoration: const BoxDecoration(
                color: Color(0xFF7D79F7), // Setting the background color of the body to purple
              ),
              child: Column(
                children: [
                  const SizedBox(height: 78), // Adjust the height as needed
                  Container(
                    height: 643,
                    decoration: const BoxDecoration(
                      color: Colors.white,
