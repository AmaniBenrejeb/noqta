...
//import 'package:mypfe/login.dart';
              ...
              child: Column(
                ...
                const  SizedBox(height: 20),
                  const SizedBox(width: 360,
                    child:Divider(color: Color(0xFFF2E5FF))),
                 const SizedBox(height: 20),
  ...
  Widget buildRow(
    ...
    onTap: () {
      if (imagePath == "images/answer.png") {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) =>const MyAnswers()),
        );
        ...
        //Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => Login_screen())); // Redirection vers l'écran de connexion
      }
    }, 
    child:SizedBox(
      width: 350,
